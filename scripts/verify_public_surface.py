...
BROWSER_FILES = ["web/index.html", "web/assets/console.css", "web/assets/console.js", "web/assets/visual-system-v3.css", "web/assets/endpoint-graph.js", "web/assets/endpoint-graph.data.json", "web/sw.js"]
