...
BROWSER_FILES = ["web/index.html", "web/assets/console.css", "web/assets/console.js", "web/assets/visual-system-v3.css", "web/assets/visual-max-v4.css", "web/assets/ux-density-v5.css", "web/assets/endpoint-graph.js", "web/assets/endpoint-graph.data.json", "web/assets/final-proof-dashboard.js", "web/assets/final-proof-dashboard.data.json", "web/assets/final-proof-dashboard.meta.json", "web/assets/runtime-console.js", "web/assets/verbose-pages.data.json", "web/sw.js"]
